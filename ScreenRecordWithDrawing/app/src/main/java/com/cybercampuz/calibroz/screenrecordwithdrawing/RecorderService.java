...
public class RecorderService extends Service implements ShakeEventManager.ShakeListener {
    ...
    private static boolean mustRecAudio = true;
...
//                            .getBoolean(getString(R.string.preference_shake_gesture_key), false);
                    boolean isShakeGestureActive = false;
...
//        updateNotification(shareNotification.build(), Const.SCREEN_RECORDER_SHARE_NOTIFICATION_ID);
    ...
    public void getValues() {
        ...
        mustRecAudio = prefs.getBoolean(getString(R.string.audiorec_key), true);
